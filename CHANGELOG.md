...
- **Data and analysis:** reusable datasets, editable/dataset-backed tables and plots, descriptive statistics, polynomial fits and derived overlays.
- **Scientific computation:** structured units, variables and computed results with dimensional semantics.
- **Diagrams:** electrical and mechanical document diagrams with dedicated editing.
- **Interchange:** CSV dataset import/export, readable Markdown export and paginated PDF export.
