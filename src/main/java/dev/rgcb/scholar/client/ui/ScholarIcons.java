...
public final class ScholarIcons {
    ...
    public static ScholarIcon forAction(EditorActionId id) {
        return switch (id) {
            ...
            case DATA_NEW_DATASET, DATA_INSERT_ANALYSIS, DATA_EDIT_ANALYSIS -> DATASET;
            case INSERT_VARIABLE, EDIT_VARIABLE -> UNIT;
            case EDIT_COMPUTED_RESULT -> EQUATION;
            case INSERT_QUANTITY_METRE, INSERT_QUANTITY_CELSIUS, INSERT_QUANTITY_CELSIUS_DIFFERENCE, INSERT_QUANTITY_VOLT,
                    ...
                    DATA_COLUMN_UNIT_CELSIUS, DATA_COLUMN_UNIT_KELVIN,
                    DATA_COLUMN_UNIT_CELSIUS_DIFFERENCE, DATA_COLUMN_UNIT_KELVIN_DIFFERENCE, DATA_COLUMN_UNIT_VOLT,
                    ...
                    PLOT_Y_UNIT_CELSIUS_DIFFERENCE, PLOT_Y_UNIT_KELVIN_DIFFERENCE, PLOT_Y_UNIT_VOLT -> UNIT;
            case INSERT_PLOT, DATA_BIND_PLOT_TO_DATASET, DATA_ADD_FIT_OVERLAY, PLOT_TOGGLE_GRID, PLOT_TOGGLE_LEGEND,
            ...
            case FILE_IMPORT_CSV, DATA_EXPORT_CSV -> DATASET;
            case FILE_EXPORT_MARKDOWN, FILE_EXPORT_PDF -> SAVE;
