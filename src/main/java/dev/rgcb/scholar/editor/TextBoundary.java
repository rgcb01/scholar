...
public final class TextBoundary {
    ...
    public static int toUtf16Index(String text, int characterOffset) {
    ...
    public static int previousOffset(String text, int characterOffset) {
        validateOffset(text, characterOffset);
        return Math.max(0, characterOffset - 1);
    }

    public static int nextOffset(String text, int characterOffset) {
        validateOffset(text, characterOffset);
        return Math.min(characterCount(text), characterOffset + 1);
    }

    public static void validateOffset(String text, int characterOffset) {
    ...
    public static String substring(String text, int startOffset, int endOffset) {
        validateRange(text, startOffset, endOffset);
        return text.substring(toUtf16Index(text, startOffset), toUtf16Index(text, endOffset));
    }

    public static void validateRange(String text, int startOffset, int endOffset) {
